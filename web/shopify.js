...
// Bypass redundant external GraphQL queries on every API request.
// Session validity, expiration, and scopes are already verified by session.isActive(api.config.scopes).
